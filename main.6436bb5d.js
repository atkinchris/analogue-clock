...
var buildArray = function buildArray(rows, columns) {
  var array = [];
  ...
  for (var y = 0; y < columns; y += 1) {
    ...
    for (var x = 0; x < rows; x += 1) {
      row.push([randomAngle(), randomAngle()]);
    }
...
var buildPosition = function buildPosition(index) {
  var x = index % 2 * 100;
  var y = Math.floor(index / 2) * 100;
...
var Digit = function Digit(_ref) {
  ...
  return clocks.map(function (rotations, index) {
    return _react2.default.createElement(
      'g',
      { transform: buildPosition(index), key: index },
      _react2.default.createElement('circle', { cx: '50', cy: '50', r: '45', className: 'frame' }),
      _react2.default.createElement(
        'g',
        { transform: 'rotate(' + rotations[0] + ' 50 50)' },
        _react2.default.createElement('line', { x1: '50', y1: '40', x2: '50', y2: '10', strokeLinecap: 'square', className: 'hand' }),
        _react2.default.createElement('line', { x1: '50', y1: '50', x2: '50', y2: '25', strokeLinecap: 'round', className: 'hand' })
      ),
      _react2.default.createElement(
        'g',
        { transform: 'rotate(' + -rotations[1] + ' 50 50)' },
        _react2.default.createElement('line', { x1: '50', y1: '40', x2: '50', y2: '10', strokeLinecap: 'square', className: 'hand' }),
        _react2.default.createElement('line', { x1: '50', y1: '50', x2: '50', y2: '25', strokeLinecap: 'round', className: 'hand' })
      )
    );
...
Digit.propTypes = {
  clocks: _propTypes2.default.arrayOf(_propTypes2.default.arrayOf(_propTypes2.default.number)).isRequired
};
...
var _Digit = __webpack_require__("./src/components/Digit.jsx");
...
var Digits = function Digits(_ref) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'svg',
      { viewBox: '0 0 800 300', width: '100%' },
      digits.map(function (clocks, index) {
        return _react2.default.createElement(
          'g',
          { transform: 'translate(' + index * 200 + ' 0)', key: index },
          _react2.default.createElement(_Digit2.default, { clocks: clocks })
        );
      })
    )
  );
...
Digits.propTypes = {
  digits: _propTypes2.default.arrayOf(_propTypes2.default.array).isRequired
};
...
var CORNER_TOP_LEFT = [90, 180];
var CORNER_TOP_RIGHT = [180, 90];
var CORNER_BOTTOM_LEFT = [0, 270];
var CORNER_BOTTOM_RIGHT = [0, 90];
var LINE_VERTICAL = [0, 180];
var LINE_UP = [0, 0];
var LINE_DOWN = [180, 180];
var LINE_LEFT = [270, 90];
var LINE_RIGHT = [90, 270];
var REST = [225, 135];

var DIGIT_ZERO = [CORNER_TOP_LEFT, CORNER_TOP_RIGHT, LINE_VERTICAL, LINE_VERTICAL, CORNER_BOTTOM_LEFT, CORNER_BOTTOM_RIGHT];

var DIGIT_ONE = [REST, LINE_DOWN, REST, LINE_VERTICAL, REST, LINE_UP];

var DIGIT_TWO = [LINE_RIGHT, CORNER_TOP_RIGHT, CORNER_TOP_LEFT, CORNER_BOTTOM_RIGHT, CORNER_BOTTOM_LEFT, LINE_LEFT];

var DIGIT_THREE = [LINE_RIGHT, CORNER_TOP_RIGHT, LINE_RIGHT, CORNER_BOTTOM_RIGHT, LINE_RIGHT, CORNER_BOTTOM_RIGHT];

var DIGIT_FOUR = [LINE_DOWN, LINE_DOWN, CORNER_BOTTOM_LEFT, LINE_VERTICAL, REST, LINE_UP];

var DIGIT_FIVE = [CORNER_TOP_LEFT, LINE_LEFT, CORNER_BOTTOM_LEFT, CORNER_TOP_RIGHT, LINE_RIGHT, CORNER_BOTTOM_RIGHT];

var DIGIT_SIX = [CORNER_TOP_LEFT, LINE_LEFT, LINE_VERTICAL, CORNER_TOP_RIGHT, CORNER_BOTTOM_LEFT, CORNER_BOTTOM_RIGHT];

var DIGIT_SEVEN = [LINE_RIGHT, CORNER_TOP_RIGHT, REST, LINE_VERTICAL, REST, LINE_UP];

var DIGIT_EIGHT = [CORNER_TOP_LEFT, CORNER_TOP_RIGHT, CORNER_BOTTOM_LEFT, CORNER_BOTTOM_RIGHT, CORNER_BOTTOM_LEFT, CORNER_BOTTOM_RIGHT];

var DIGIT_NINE = [CORNER_TOP_LEFT, CORNER_TOP_RIGHT, CORNER_BOTTOM_LEFT, LINE_VERTICAL, LINE_RIGHT, CORNER_BOTTOM_RIGHT];
...
var _Digits = __webpack_require__("./src/components/Digits.jsx");

var _Digits2 = _interopRequireDefault(_Digits);

var _digits = __webpack_require__("./src/digits.js");

var _digits2 = _interopRequireDefault(_digits);

var _buildArray = __webpack_require__("./src/buildArray.js");

var _buildArray2 = _interopRequireDefault(_buildArray);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var mountElement = document.getElementById('root');
var tick = 1;
var digits = (0, _buildArray2.default)(6, 4);
...
var update = function update() {
  ...
  var showTime = seconds < 25;

  time.split('').forEach(function (character, digitIndex) {
    var digit = _digits2.default[character];
    var clocks = digits[digitIndex];

    clocks.forEach(function (clock, clockIndex) {
      var position = digit[clockIndex];
  ...
  (0, _reactDom.render)(_react2.default.createElement(_Digits2.default, { digits: digits }), mountElement);
...
/******/ });
//# sourceMappingURL=main.6436bb5d.js.map